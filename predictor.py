...
def get_obc_ratio(p: float) -> float:
    ...
    """High-precision interpolation for CRL/OBC ratio using NumPy."""
    ...
    xp = [
        ...
        70.0, 75.0, 80.0, 85.0, 90.0, 91.0, 92.0, 93.0, 94.0, 95.0, 95.5, 96.0, 96.5, 



        97.0, 97.5, 98.0, 98.3, 98.5, 98.7, 99.0, 99.1, 99.2, 99.3, 99.4, 99.5, 99.6, 
    ...
    fp = [
        ...
        2.98, 2.80, 2.71, 2.71, 2.71, 2.71, 2.72, 2.72, 2.73, 2.74, 2.75, 2.76, 2.77, 2.79, 



        2.81, 2.83, 2.85, 2.92, 3.05, 3.07, 3.10, 3.15, 3.22, 3.30, 3.32, 3.36, 3.42, 3.50, 



        3.60, 3.71, 3.80, 3.86, 3.94, 4.06, 4.14, 4.22, 4.30, 4.43, 4.56, 4.85, 5.15, 5.52, 
