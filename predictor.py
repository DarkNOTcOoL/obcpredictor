...
def get_obc_ratio(p: float) -> float:
    xp = [
        ...
        55.0, 60.0, 65.0, 70.0, 75.0, 80.0, 81.0, 82.0, 83.0, 84.0, 
        85.0, 86.0, 87.0, 88.0, 89.0, 90.0, 91.0, 92.0, 93.0, 94.0, 
        95.0, 96.0, 97.0, 98.0, 99.0, 99.5, 99.9, 100.0
    ]
    fp = [
        2.07, 2.07, 2.08, 2.08, 2.09, 2.09, 2.10, 2.11, 2.12, 2.13, 
        2.15, 2.18, 2.21, 2.26, 2.32, 2.39, 2.41, 2.43, 2.45, 2.48, 
        2.51, 2.54, 2.57, 2.60, 2.63, 2.66, 2.71, 2.76, 2.82, 2.89, 
        2.98, 3.08, 3.18, 3.37, 3.48, 3.88, 4.19, 4.19
    ]
