...
# Combined Dataset: Organized from hardest to easiest cutoff
NIT_DATA = [
...
# Use the active median predicted rank from the UI session state
...
for nit in NIT_DATA:
    ...
    # Constraint: In no circumstances should there be any more colleges than these 3
